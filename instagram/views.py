...
def timeline(request):
    ...
    try:
        if is_following != 0:
            ...
            return render(request, 'all_insta/timeline.html',{"date":date,"timeline_images":images})
    except:
        raise Http404
    return render(request, 'all_insta/insta.html') 
...
def search_results(request):
    if 'name' in request.GET and request.GET["name"]: 
        ...
        return render(request,'all_insta/search.html',{"message":message,"found_users":found_users})
    else:
        message = "Please enter a valid username"
    return render(request,'all_insta/search.html',{"message":message})
...
def single_user(request,id):
    try:
        ...
        raise Http404()
    return render(request,'all_insta/single.html',{"user":user})
...
def single_image(request,image_id): 
    try:
        ...
        raise Http404()
    return render(request, 'all_insta/image.html',{"image":image})
...
def post(request):
    ...
    if request.method == 'POST':
        ...
        form = ImageForm() 
    return render(request, 'all_insta/post.html',{"form" : form}) 
...
def comment(request, image_id):
    ...
    if request.method == 'POST':
        ...
        form = CommentForm()
    return render(request,'all_insta/comment.html',{"form":form,"comments":comments})  
...
def more(request,image_id):
    ...
    return render(request,'all_insta/many.html',{"image":image, "form":form}) 
...
def like(request,image_id):
    ...
    return render(request,'all_insta/timeline.html')
...
def test(request):                                                                                                                                                                                                                                                                                                                                                                  
    return render(request, 'all_insta/test.html')